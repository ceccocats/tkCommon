...
class grid
{
    ...
    public:
        bool init(){
            std::string vertex      = std::string(TKPROJ_PATH) + "include/tkCommon/gui/components/grid/grid.vert";
            std::string fragment    = std::string(TKPROJ_PATH) + "include/tkCommon/gui/components/grid/grid.frag";        
